...
<h2 style="font-size: 24px;
    font-style: italic;
    font-variant: small-caps;">Sell Equity</h2>
    <center>
<form:form action="sellstock.htm" commandName="tradeOrder" method="post">

<table>
<tr>
    <td>Stock Name:</td>
    <td><form:input path="stockId" value="${id}" size="30" /> </td>
</tr>

<tr>
    <td>Trader Id:</td>
    <td><form:input path="traderId" value="${user.id}" size="30" /> </td>
</tr>

<tr>
    <td>sell date:</td>
    <td><form:input path="sellDate" value="<%=new java.util.Date()%>" size="30" /> </td>
</tr>


<tr>
    <td>Sell Price:</td>
    <td><form:input path="sellPrice" size="30" /> <font color="red"><form:errors path="sellPrice"/></font></td>
</tr>
...
<tr>
    <td>Trigger Price:</td>
    <td><form:input path="triggerPrice" size="30" /> <font color="red"><form:errors path="triggerPrice"/></font></td>
</tr>
