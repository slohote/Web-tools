...
<center>
<h2>Trader-Probability Of Default</h2>
<table border=1 style="align-content: center;
    ...
    background-color: black;">
             ...
             <c:forEach var="trader" items="${trader}">
                <tr>
                    <td>${trader.id}</td>
                    <td>${trader.firstName}</td>
                    <td>${trader.lastName}</td>
                    <td>${trader.emailId}</td>
                    <td>${trader.creditScore}</td>
                    
                    <td><a href="setcredit.htm?id=${trader.id}">Add Credit score</a></td>
