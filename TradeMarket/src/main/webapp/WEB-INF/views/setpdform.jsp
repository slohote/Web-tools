...
<center>
<form action="setcredit.htm" method="post">
<table>
<tr>
...
<td>
<input type="text" name="id" value="${trader.id}"/>
</td>
</tr>
<td>
Credit score:
...
<td>
<input type="text" name="score" value="${trader.creditScore}" />
</td>
</tr>
<tr>
<td><input type="submit" value="Set credit score" style="margin-left:100px;background-color: black;color: white;"/></td>
</tr>
