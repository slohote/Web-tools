...
<h2>Add stock event</h2>
<center>
<form:form action="addevent.htm" commandName="stockEvent" method="post">
...
<tr>
    <td>Event Date:</td>
    <td><form:input type="date" path="date" size="30" /> <font color="red"><form:errors path="date"/></font></td>
</tr>

<tr>
    <td>Event Description:</td>
    <td><form:password type="textarea" path="eventDescription" size="30" /> <font color="red"><form:errors path="eventDescription"/></font></td>
</tr>

 
<tr>
    <td colspan="2"><input type="submit" value="Add event" style="margin-left:100px;background-color: black;color: white;"/></td>
</tr>
</table>
