...
<c:choose>
<c:when test="${Message eq 'You are not eligible for trading!'}">
<div>
<h2>You are not eligible for trading!</h2>
...
<c:otherwise>
<h2>
Your Trading order is placed on exchange successfully!!!
Order Number:${generatedId}
</h2>
</c:otherwise>
